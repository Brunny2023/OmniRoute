/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc` (hash: d64904393ae62443530d005bbd184d0b)
// Runtime types generated with workerd@1.20260804.1 2026-08-11
interface __BaseEnv_Env {
	OMNIROUTE_EDGE_RATE_LIMIT_MAX: "120";
	OMNIROUTE_EDGE_RATE_LIMIT_WINDOW_MS: "60000";
	OMNIROUTE_MAX_REQUEST_BYTES: "52428800";
	OMNIROUTE_CONTAINER_SLEEP_AFTER: "20m";
	JWT_SECRET: string;
	API_KEY_SECRET: string;
	INITIAL_PASSWORD: string;
	STORAGE_ENCRYPTION_KEY: string;
	OMNIROUTE_WS_BRIDGE_SECRET: string;
	OMNIROUTE_CONTAINER: DurableObjectNamespace<import("./src/cloudflare/index").OmniRouteContainer>;
	OMNIROUTE_EDGE_RATE_LIMITER: DurableObjectNamespace<import("./src/cloudflare/index").EdgeRateLimiter>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/cloudflare/index");
		durableNamespaces: "OmniRouteContainer" | "EdgeRateLimiter";
	}
